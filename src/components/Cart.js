    ...
    productsInCart = productsInCart.map((product, index) =>  {
        ...
        return (
            <Fragment key={index}>
                ...
                <i onClick={ () => clearProduct(product.name)} className="far fa-times-circle"></i>
                    <img src={productImages[index]} alt="Loading..." />
                    <span className="sm-hide">{product.name}</span>
                </div>
                <div className="price sm-hide">${product.price},</div>
                <div className="quantity">
                <i onClick={()=> productQuantity('decrease', product.name)} className="decrease far fa-arrow-alt-circle-left"></i>
                    <span>{product.numbers}</span>
                <i onClick={()=> productQuantity('increase', product.name)} className="increase far fa-arrow-alt-circle-right"></i>    
                </div>
